...
- [Main Script: BamDam.py](#main-script-bamdam.py)
- [Explanation of the Output Stats File Columns](#explanation-of-the-output-stats-file-columns)
- [Plotting Script](#plotting-script)
- [Coming Soon / To Do List](#coming-soon--to-do-list)
- [License](#license)

## Installation

There is no installation required - just download this Github repo, make sure you have the python and R libraries installed (they should be pretty standard) and run it.
...
- **"Damaged+1"**: The number of reads assigned to that node or underneath where every alignment had a C->T on the 5' (+1) position. 
- **"Damaged-1"**: The number of reads assigned to that node or underneath where every alignment had a C->T if single stranded, or a G->A if double stranded, on the 3' (-1) position.
...
Please let me know if you have requests, or really like any of these ideas.
